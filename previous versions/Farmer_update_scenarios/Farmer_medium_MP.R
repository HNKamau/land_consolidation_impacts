...
lessor_fee1 <-vv(compensation_income_pm_acre, gen_CV, n_years)* 2 * 
...
farmer_benefit_interv1 <-
  lessor_fee1 + off_farm_income1 + production_costs_saved1 + 
  sale_of_hh_items_not_needed +  medical_bills_saved1 + social_cohesion1 + 
  better_childhood1

# E) Calculate net benefit ####
farmer_pre_interv_netbenefit_kes1 <- farmer_pre_interv_benefit1 -
                                            farmer_pre_interv_cost1

result_pre_intervention1 <- farmer_pre_interv_netbenefit_kes1/currency_change
    
farmer_interv_netbenefit_kes1 <- farmer_benefit_interv1 - farmer_cost_interv1

result_intervention1 <- farmer_interv_netbenefit_kes1/currency_change
...
lease_npv1 <- discount(lessor_fee1, discount_rate, calculate_NPV = T)
...
# NPV ####
NPV_interv_kes1 <- discount(farmer_interv_netbenefit_kes1, discount_rate,
                           calculate_NPV = TRUE)
NPV_intervention1 <- 
  discount(result_intervention1, discount_rate, calculate_NPV = T)

NPV_n_interv_kes1 <- discount(farmer_pre_interv_netbenefit_kes1, discount_rate,
                             calculate_NPV = TRUE)

NPV_n_intervention1 <- 
    discount(result_pre_intervention1, discount_rate, calculate_NPV = T)
...
# with intervention
npv_farmer_benefit_interv1 <- discount(farmer_benefit_interv1, discount_rate, 
                                      calculate_NPV = T)
...
#                Cashflow_decision_do1 = farmer_interv_netbenefit_kes1 -
