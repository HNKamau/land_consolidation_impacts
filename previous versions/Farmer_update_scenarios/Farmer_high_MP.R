...
lessor_fee2 <-vv(compensation_income_pm_acre, gen_CV, n_years)* 2 * 
...
farmer_benefit_interv2 <-
  lessor_fee2 + off_farm_income2 + production_costs_saved2 + 
  sale_of_hh_items_not_needed +  medical_bills_saved2 + social_cohesion2 + 
  better_childhood2

# E) Calculate net benefit ####
farmer_pre_interv_netbenefit_kes2 <- farmer_pre_interv_benefit2 -
                                            farmer_pre_interv_cost2

result_pre_intervention2 <- farmer_pre_interv_netbenefit_kes2/currency_change
    
farmer_interv_netbenefit_kes2 <- farmer_benefit_interv2 - farmer_cost_interv2

result_intervention2 <- farmer_interv_netbenefit_kes2/currency_change
...
lease_npv2 <- discount(lessor_fee2, discount_rate, calculate_NPV = T)
...
# NPV ####
NPV_interv_kes2 <- discount(farmer_interv_netbenefit_kes2, discount_rate,
                           calculate_NPV = TRUE)
NPV_intervention2 <- 
  discount(result_intervention2, discount_rate, calculate_NPV = T)

NPV_n_interv_kes2 <- discount(farmer_pre_interv_netbenefit_kes2, discount_rate,
                             calculate_NPV = TRUE)

NPV_n_intervention2 <- 
    discount(result_pre_intervention2, discount_rate, calculate_NPV = T)
...
# with intervention
npv_farmer_benefit_interv2 <- discount(farmer_benefit_interv2, discount_rate, 
                                      calculate_NPV = T)
...
#    return(list(Interv_NPV_kes2 = NPV_interv_kes2,
...
#                Cashflow_decision_do2 = farmer_interv_netbenefit_kes2 -
