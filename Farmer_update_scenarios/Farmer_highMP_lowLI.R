...
lessor_fee20 <-vv(compensation_income_pm_acre, gen_CV, n_years)* 2 * 
...
farmer_benefit_interv20 <-
  lessor_fee20 + off_farm_income2 + production_costs_saved2 + 
  sale_of_hh_items_not_needed +  medical_bills_saved2 + social_cohesion2 + 
  better_childhood2

# E) Calculate net benefit ####
farmer_pre_interv_netbenefit_kes20 <- farmer_pre_interv_benefit2 -
                                            farmer_pre_interv_cost2

result_pre_intervention20 <- farmer_pre_interv_netbenefit_kes20/currency_change
    
farmer_interv_netbenefit_kes20 <- farmer_benefit_interv20 - farmer_cost_interv2

result_intervention20 <- farmer_interv_netbenefit_kes20/currency_change
...
lease_npv20 <- discount(lessor_fee20, discount_rate, calculate_NPV = T)
...
# NPV ####
NPV_interv_kes20 <- discount(farmer_interv_netbenefit_kes20, discount_rate,
                           calculate_NPV = TRUE)
NPV_intervention20 <- 
  discount(result_intervention20, discount_rate, calculate_NPV = T)

NPV_n_interv_kes20 <- discount(farmer_pre_interv_netbenefit_kes20, discount_rate,
                             calculate_NPV = TRUE)

NPV_n_intervention20 <- 
    discount(result_pre_intervention20, discount_rate, calculate_NPV = T)
...
# with intervention
npv_farmer_benefit_interv2 <- discount(farmer_benefit_interv20, discount_rate, 
                                      calculate_NPV = T)
...
#    return(list(Interv_NPV_kes20 = NPV_interv_kes20,
