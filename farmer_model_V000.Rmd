...
---
title: "Simulating outcomes of the effects of land consolidation to support farmer's decision for improved livelihood"
author: |
  Hannah Kamau\textsuperscript{1,*},  Cory Whitney\textsuperscript{1,2}
output: 
  pdf_document:
    toc: false
    toc_depth: 2
...
---
 \textsuperscript{1} Center for Development Research (ZEF), University of Bonn, Genscherallee 3, 53113 Bonn, Germany
\
\textsuperscript{2} INRES-Horticultural Sciences, University of Bonn, Auf dem Hugel 6, 53121 Bonn, Germany
\
\textsuperscript{*} Corresponding author's email: hannah.nyakio@gmail.com
