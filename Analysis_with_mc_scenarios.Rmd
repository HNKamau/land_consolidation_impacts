...
This document is a supplementary resource and contains the description of the land consolidation model used to simulate outcomes of the decision to consolidate land in Kenya by smallholder farmers. Impact pathway model was created in March 2024 after co-creating a conceptual model with the stakeholders. Data used here was obtained from expert estimates and from published literature. 
